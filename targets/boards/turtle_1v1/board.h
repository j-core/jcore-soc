...
#define DEVICE_AIC1 ((volatile struct aic_regs *) DEVICE_AIC1_ADDR)
...
struct emac_regs {
  ...
  uint32_t debug;
  uint32_t ignore0[3];
  uint32_t tstamp_tx_sec_hi;
  uint32_t tstamp_tx_sec_lo;
  uint32_t tstamp_tx_nsec;
  uint32_t ignore1;
  uint32_t tstamp_rx_sec_hi;
  uint32_t tstamp_rx_sec_lo;
  uint32_t ignore2[1010];
  uint32_t rx_buffer[512];
  uint32_t tx_buffer[512];
};
#define DEVICE_EMAC ((volatile struct emac_regs *) DEVICE_EMAC_ADDR)
